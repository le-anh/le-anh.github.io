...
<div class="card pd-20 pd-sm-40">
    ...
    <form role="form" action="{{ route('admin.product_type_specification.update') }}" method="post" enctype="multipart/form-data">
        @method('PUT')
        @csrf()
        <input type="hidden" id="id" name="id" value="{{ $productTypeSpecification->id }}">
        ...
        <div class="row pd-20 pd-sm-40">
            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            <select name="product_type_id" id="product_type_id" class="form-control @error('product_type_id') is-invalid @enderror">
                                ...
                                <option value="{{ $productType->id }}" {{$productType->id == old('product_type_id', $productTypeSpecification->product_type_id) ? 'selected' : ''}}> {{ $productType->name }} </option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            ...
                            <input type="number" id="net_weight" name="net_weight" class="form-control @error('net_weight') is-invalid @enderror" value="{{ old('net_weight', $productTypeSpecification->net_weight)}}" placeholder="Net weight" autofocus>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            ...
                            <input type="text" id="description" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Description" value="{{ old('description', $productTypeSpecification->description) }}">
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <label class="ckbox">
                            <input type="checkbox" id="show" name="show" class="@error('show') is-invalid @enderror" {{ old('show', $productTypeSpecification->show) ? 'checked' : ''}}><span> Show </span>
                        </label>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 text-center pd-t-10 rounded" style="background: #D8DCE3;">
                <img id="imgshow" name="imgshow" src="{{ asset('storage/app/' . $productTypeSpecification->image_link) }}" class="img-thumbnail" alt="" style="max-height: 300px; max-width: 300px;">
            </div>
        </div>
