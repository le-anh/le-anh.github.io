...
<div class="card pd-20 pd-sm-40">
    ...
    <form role="form" action="{{ route('admin.product_type.store') }}" method="post" enctype="multipart/form-data">
        @csrf()
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-8 col-xl-7">
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name')}}" placeholder="Name" autofocus>
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text tx-16 lh-0 op-6"></i></span>
                            <input type="text" id="ingredient" name="ingredient" class="form-control @error('ingredient') is-invalid @enderror" value="{{ old('ingredient')}}" placeholder="Ingredient" autofocus>
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text tx-16 lh-0 op-6"></i></span>
                            <input type="text" id="use_manual" name="use_manual" class="form-control @error('use_manual') is-invalid @enderror" value="{{ old('use_manual')}}" placeholder="Use manual" autofocus>
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            ...
                            <input type="number" id="use_periord" name="use_periord" class="form-control @error('use_periord') is-invalid @enderror" value="{{ old('use_periord')}}" placeholder="Use periord" autofocus>
                        </div>
