...
<div class="row col-md-12">
    <div class="map-link">
        <a href="{{ route('admin.dashboard') }}"> Dashboard <i class="fa fa-caret-right"></i> </a>  <a href="{{ route('admin.gallerry.index') }}"> Gallerry <i class="fa fa-caret-right"></i> </a> <a href=""> Edit </a>
    </div>
</div>
@endsection
@section('container')
<div class="card pd-20 pd-sm-40">
    <div>
        <h6 class="card-body-title">Gallerry</h6>
    ...
    <form role="form" action="{{ route('admin.gallerry.update') }}" method="post" enctype="multipart/form-data">
        @method('PUT')
        @csrf()
        <input type="hidden" id="id" name="id" value="{{ $gallerry->id }}">
        ...
        <div class="row pd-20 pd-sm-40">
            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            ...
                            <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Title" value="{{ old('title', $gallerry->title) }}">
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text tx-16 lh-0 op-6"></i></span>
                            <input type="text" id="description" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Description" value="{{ old('description', $gallerry->text) }}">
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            ...
                            <input type="number" id="order" name="order" class="form-control @error('order') is-invalid @enderror" placeholder="Order" value="{{ old('order', $gallerry->order) }}">
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <label class="ckbox">
                            <input type="checkbox" id="show" name="show" class="@error('show') is-invalid @enderror" {{ old('show', $gallerry->show) ? 'checked' : ''}}><span> Show </span>
                        </label>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 text-center pd-t-10 rounded" style="background: #D8DCE3;">
                <img id="imgshow" name="imgshow" src="{{ asset('storage/app/' . $gallerry->image_link) }}" class="rounded-circle img-thumbnail" alt="" style="max-height: 300px; max-width: 300px;">
            </div>
        </div>

        <div class="form-layout-footer mg-t-30 text-center">
            <button class="btn btn-info mg-r-5"> <i class="fa fa-save"></i> Save </button>
            <button class="btn btn-secondary"> <i class="fa fa-retweet"></i> Cancel </button>
