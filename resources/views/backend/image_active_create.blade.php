...
<div class="card pd-20 pd-sm-40">
    ...
    <form role="form" action="{{ route('admin.gallerry.store') }}" method="post" enctype="multipart/form-data">
        @csrf()
        ...
        <div class="row pd-20 pd-sm-40">
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-5 text-center align-middle pd-t-10 rounded" style="background: #D8DCE3;">
                <img id="imgshow" name="imgshow" src="{{ asset('') }}" class="rounded-circle img-thumbnail" alt="PHOTO" style="max-height: 300px; max-width: 300px;">
            </div>
