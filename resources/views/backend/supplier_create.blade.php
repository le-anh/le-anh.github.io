            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                    <div class="input-group">
                        ...
                        <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name')}}" placeholder="Name" autofocus required>
                    </div>
            ...
            <div class="row mg-t-20">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                    <div class="input-group">
                        ...
                        <input type="text" id="surrogate" name="surrogate" class="form-control @error('surrogate') is-invalid @enderror" value="{{ old('surrogate')}}" placeholder="Surrogate" autofocus>
                    </div>
            ...
            <div class="row mg-t-20">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                    <div class="input-group">
                        ...
                        <input type="text" id="phone" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone')}}" placeholder="Phone" autofocus>
                    </div>
            ...
            <div class="row mg-t-20">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                    <div class="input-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email')}}" placeholder="Email" autofocus>
                    </div>
            ...
            <div class="row mg-t-20">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                    <div class="input-group">
                        ...
                        <input type="text" id="address" name="address" class="form-control @error('address') is-invalid @enderror" value="{{ old('address')}}" placeholder="Address" autofocus>
                    </div>
