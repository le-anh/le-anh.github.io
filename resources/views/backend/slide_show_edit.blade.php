...
<div class="row col-md-12">
    <div class="map-link">
        <a href="{{ route('admin.dashboard') }}"> Dashboard <i class="fa fa-caret-right"></i> </a>  <a href="{{ route('admin.slide_show.index') }}"> Slide show <i class="fa fa-caret-right"></i> </a> <a href=""> Edit </a>
    </div>
</div>
@endsection
@section('container')
...
<div class="card pd-20 pd-sm-40">
    <div>
        <h6 class="card-body-title">Slide show</h6>
    ...
    <form role="form" action="{{ route('admin.slide_show.update') }}" method="post" enctype="multipart/form-data">
        @method('PUT')
        @csrf()
        ...
        <div class="row pd-20 pd-sm-40">
            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            ...
                            <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Title" value="{{ old('title', $slideShow->title) }}">
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text tx-16 lh-0 op-6"></i></span>
                            <input type="text" id="content" name="content" class="form-control @error('content') is-invalid @enderror" placeholder="Content" value="{{ old('content', $slideShow->text) }}">
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            ...
                            <input type="number" id="order" name="order" class="form-control @error('order') is-invalid @enderror" placeholder="Order" value="{{ old('order', $slideShow->order) }}">
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <label class="ckbox">
                            <input type="checkbox" id="show" name="show" class="@error('show') is-invalid @enderror" {{ old('show', $slideShow->show) ? 'checked' : ''}}><span> Show </span>
                        </label>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 text-center pd-t-10 rounded" style="background: #D8DCE3;">
                <img id="imgshow" name="imgshow" src="{{ asset('storage/app/' . $slideShow->image_link) }}" class="img-thumbnail" alt="" style="max-height: 300px; max-width: 300px;">
            </div>
        </div>
