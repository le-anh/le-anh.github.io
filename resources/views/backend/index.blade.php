    ...
    <div class="card">
        ...
        <table class="table table-white mg-b-0 tx-12">
            ...
            <tr>
                ...
                <img src="{{ asset('resources/views/backend/template/img/img1.jpg') }}" class="wd-36 rounded-circle" alt="Image">
                </td>
                <td>
            ...
            <tr>
                <td class="pd-l-20 tx-center">
                <img src="{{ asset('resources/views/backend/template/img/img2.jpg') }}" class="wd-36 rounded-circle" alt="Image">
                </td>
                <td>
            ...
            <tr>
                <td class="pd-l-20 tx-center">
                <img src="{{ asset('resources/views/backend/template/img/img3.jpg') }}" class="wd-36 rounded-circle" alt="Image">
                </td>
                <td>
            ...
            <tr>
                <td class="pd-l-20 tx-center">
                <img src="{{ asset('resources/views/backend/template/img/img5.jpg') }}" class="wd-36 rounded-circle" alt="Image">
                </td>
                <td>
            ...
            <tr>
                <td class="pd-l-20 tx-center">
                <img src="{{ asset('resources/views/backend/template/img/img4.jpg') }}" class="wd-36 rounded-circle" alt="Image">
                </td>
                <td>
