...
<div class="card pd-20 pd-sm-40">
    ...
    <form role="form" action="{{ route('admin.green_bean_coffee_type.store') }}" method="post" enctype="multipart/form-data">
        @csrf()
            ...
            <div class="row mg-t-20">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                    <div class="input-group">
                        ...
                        <input type="text" id="note" name="note" class="form-control @error('note') is-invalid @enderror" value="{{ old('note')}}" placeholder="Note" autofocus>
                    </div>
