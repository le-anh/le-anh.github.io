...
<div class="card pd-20 pd-sm-40">
    ...
    <form role="form" action="{{ route('admin.slide_show.store') }}" method="post" enctype="multipart/form-data">
        @csrf()
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-8 col-xl-7">
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-text tx-16 lh-0 op-6"></i></span>
                            <input type="text" id="content" name="content" class="form-control @error('content') is-invalid @enderror" placeholder="Content">
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <div class="input-group">
                            ...
                            <input type="number" id="order" name="order" class="form-control @error('order') is-invalid @enderror" placeholder="Order">
                        </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-10 mg-t-10 mg-sm-t-0">
                        <label class="ckbox">
                            <input type="checkbox" id="show" name="show" class="@error('show') is-invalid @enderror" {{ old('show', $slideShow->show) ? 'checked' : ''}} checked><span> Show </span>
                        </label>
